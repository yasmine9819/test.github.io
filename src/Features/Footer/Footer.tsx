...
export default function Footer() {
  return (
    <footer className="w-full pt-20 pb-20 bg-gray-900 md:pl-5 md:pr-5 ">
      <div className="justify-between w-1/2 m-auto space-y-5 text-center md:space-x-5 md:space-y-0 md:text-left md:max-w-7xl md:w-full md:flex">
        {/* first */}
        <ul>
          <li>
          ...
          <li className="flex justify-center pt-4 space-x-2 md:justify-start">
            <svg
          ...
          <li className="flex justify-center pt-2 space-x-2 md:justify-start">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="white"
              viewBox="0 0 24 24"
            ...
            <text className="text-gray-300">{"softgroup@gmail.com"}</text>
          </li>
          <li className="flex justify-center pt-5 space-x-2 md:justify-start">
            <svg
              viewBox="0 0 512 512"
              fill="white"
              xmlns="http://www.w3.org/2000/svg"
        ...
        <ul>
          ...
          <li className="pt-5 ">
            <text className="text-gray-400 ">
              {"Aliquam blandit augue ac sapien sodales pellentesque! "}
            </text>
          </li>
          <li className="flex mt-5 border ">
            <input
